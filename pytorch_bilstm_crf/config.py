...
class ArgsParse:
    ...
    def initialize(parser):
        ...
        parser.add_argument('--lr', default=1e-3, help='非模型层的学习率')
        ...
        # 模型数据保存参数
        parser.add_argument('--load_model_A', default='model_A.bin', help='A模型存盘文件')
        parser.add_argument('--load_model_B', default='model_B.bin', help='B模型存盘文件')
